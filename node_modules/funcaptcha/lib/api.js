...
const http_1 = require("funcaptcha/lib/http");
const util_1 = require("funcaptcha/lib/util");
async function getToken(options) {
    ...
    if (options.site) {
        ...
        options.headers["Referer"] = `${options.surl}/v2/${options.pkey}/1.5.4/enforcement.${util_1.default.random()}.html`;
    }
